...
- 🌱 I’m currently learning **Machine Learning, ML DevOps MML, and Amazon Web Services (AWS Amplify, Lambda, CloudWatch, S3, Ec2) to be able to scale and build my Fullstack Web Applications**
